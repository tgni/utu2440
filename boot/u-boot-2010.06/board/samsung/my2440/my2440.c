...
/*
	...
	gpio->GPBCON = 0x00295559;
	gpio->GPBUP  = 0x000003FF;
	gpio->GPBDAT = 0x000007C2;
	gpio->GPCCON = 0xAAAAA6AA;
	gpio->GPCUP  = 0x0000FFFF;
	gpio->GPCDAT = 0x00000020;
	gpio->GPDCON = 0xAAAAAAAA;
	gpio->GPDUP  = 0x0000FFFF;
	gpio->GPECON = 0xAAAAAAAA;
	gpio->GPEUP  = 0x0000FFFF;
	gpio->GPFCON = 0x000055ff;
	gpio->GPFUP  = 0x000000FF;
	gpio->GPFDAT = 0x000000FF;
	gpio->GPGCON = 0x00150114;
	gpio->GPGUP  = 0x0000007F;
	gpio->GPHCON = 0x0015AAAA;
	gpio->GPHUP  = 0x000003FF;
*/
